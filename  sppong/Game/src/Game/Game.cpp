...
{
	m_pPaddleSprite->Init(m_pD3dDevice, _T("..\\bin\\resources\\paddle.jpg"));
	m_pBallSprite->Init(m_pD3dDevice, _T("..\\bin\\resources\\ball.png"));
	m_pWallSprite->Init(m_pD3dDevice, _T("..\\bin\\resources\\wall.png"));
