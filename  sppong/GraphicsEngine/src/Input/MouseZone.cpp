...
// Add a new zone
// ***************************************************************
GRAPHIC_API void cMouseZone::AddZone( LPTSTR const szZoneName, const int iPosX, const int iPosY, const int iWidth, const int iHeight, const eMouseClickType eClickType )
{
	
	stHotSpot hotSpot;
	hotSpot.m_szZoneName = szZoneName;
...
// ***************************************************************
bool cMouseZone::CheckZones( const int iPosX, const int iPosY, const bool* const pbMouseButtons, LPTSTR szHitZoneName )
{
