...
namespace Utilities
{
	...
	public:
		...
		UTILITIES_API virtual Base::tOptional<int> VGetParameterValueAsInt(const Base::cString & strParameter, const int iDefaultValue) = 0;
		UTILITIES_API virtual Base::tOptional<float> VGetParameterValueAsFloat(const Base::cString & strParameter, const float fDefaultValue) = 0;
		UTILITIES_API virtual Base::tOptional<bool> VGetParameterValueAsBool(const Base::cString & strParameter, const bool bDefaultValue) = 0;
		UTILITIES_API virtual Base::tOptional<Base::cString> VGetParameterValueAsString(const Base::cString & strParameter, const Base::cString & strDefaultValue) = 0;
